...
<div class="col-md-2 col-md-offset-7 right-sidebar-image">
  ...
  <?php } ?>
  <!--
  <img src = "https://upload.wikimedia.org/wikipedia/commons/thumb/1/15/Red_Apple.jpg/500px-Red_Apple.jpg" width="100%" alt = "ERROR" class = "img-rounded img-responsive">
  <div class = "image-space"></div>
  <img src = "https://upload.wikimedia.org/wikipedia/commons/thumb/c/c9/Malus_domestica_-_K%C3%B6hler%E2%80%93s_Medizinal-Pflanzen-108.jpg/220px-Malus_domestica_-_K%C3%B6hler%E2%80%93s_Medizinal-Pflanzen-108.jpg" width="100%" alt = "ERROR" class = "img-rounded img-responsive">
  <div class = "image-space"></div>
  <img src = "https://upload.wikimedia.org/wikipedia/commons/thumb/9/92/95apple.jpeg/500px-95apple.jpeg" width="100%" alt = "ERROR" class = "img-rounded img-responsive">
  -->
</div>
        ...
        <tr>
		  ...
		  <table class = "table">
		    <tbody align = "right">
		      ...
		      <!--
		      <tr>
		        <td align = "left">Caffine</td>
		        <td><?php if($nutri['Caffine'] != NULL) echo $nutri['Caffine'] . ' mg' ?></td>
		        <td></td>
		      </tr>
		      -->
		    </tbody>
